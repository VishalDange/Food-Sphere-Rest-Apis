...
public class AdminRestaurantController {
    ...
    @PostMapping()
    public ResponseEntity<Restaurant> createRestaurant(@RequestHeader("Authorization") String jwt, @RequestBody CreateRestaurantRequest request) throws Exception {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Restaurant> updateRestaurant(@RequestHeader("Authorization") String jwt, @PathVariable Long id, @RequestBody CreateRestaurantRequest request) throws Exception {
        User user = userService.findUserByJwtToken(jwt);
